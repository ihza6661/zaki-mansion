      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="luxury-body text-base md:text-lg mb-12 max-w-2xl mx-auto">
            Hubungi tim sales kami untuk informasi lebih lanjut, jadwal
            kunjungan ke lokasi, atau konsultasi mengenai unit yang sesuai
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-sans">Developer Terpercaya</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-sm font-sans">Legalitas Lengkap</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-sm font-sans">KPR Dibantu</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
