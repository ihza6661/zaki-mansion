      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div>
            ...
            <p className="font-sans text-sm font-light text-background/60 leading-relaxed mb-6">
              Hunian premium dengan desain modern dan kenyamanan maksimal di
              jantung Kota Pontianak.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Beranda", "Fasilitas", "Unit", "Lokasi", "Kontak"].map(
                (link) => (
                  <li key={link}>
                    <a
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="mailto:info@zakimansion.com"
                  className="font-sans text-sm font-light text-background/60 hover:text-gold transition-colors duration-300"
                >
                  info@zakimansion.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-background/10">
          <p className="font-sans text-xs text-background/40 text-center">
            © {new Date().getFullYear()} Zaki Mansion. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
