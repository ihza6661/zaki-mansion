...
export const PROPERTY_DETAILS: PropertyDetails = {
  ...
  description:
    "Temukan Hunian Ideal dengan desain modern dan kenyamanan maksimal di Kota Pontianak",
  location: "Pontianak, Kalimantan Barat",
  mapEmbedUrl:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127672.75772082095!2d109.26539!3d-0.02123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e1d5987fd61ee53%3A0x88b38f3d04c3adac!2sPontianak%2C%20Pontianak%20City%2C%20West%20Kalimantan!5e0!3m2!1sen!2sid!4v1703000000000!5m2!1sen!2sid",
};
...
export const SITE_CONTENT = {
  hero: {
    ...
    image: heroImage,
    imageAlt:
      "Zaki Mansion - Hunian mewah dengan arsitektur modern di Kota Pontianak, menampilkan fasad elegan dan landscape premium",
  },
  ...
  experience: {
    ...
    image: interiorImage,
    imageAlt:
      "Interior mewah Zaki Mansion dengan ruang tamu luas, pencahayaan alami optimal, dan desain minimalis kontemporer menggunakan material premium",
  },

  amenities: {
    title: "Fasilitas Premium",
    description:
      "Nikmati berbagai fasilitas eksklusif yang dirancang untuk meningkatkan kualitas hidup Anda dan keluarga",
    additionalFeatures: [
  ...
  units: {
    title: "Pilihan Unit",
    description:
      "Berbagai pilihan tipe rumah yang dapat disesuaikan dengan kebutuhan dan gaya hidup keluarga Anda",
  ...
  location: {
    ...
    description:
      "Terletak di kawasan premium Kota Pontianak dengan akses mudah ke berbagai fasilitas umum, pusat perbelanjaan, sekolah, dan rumah sakit terkemuka.",
  ...
  contact: {
    ...
    description:
      "Hubungi tim sales kami untuk informasi lebih lanjut, jadwal kunjungan ke lokasi, atau konsultasi mengenai unit yang sesuai dengan kebutuhan Anda.",
  ...
  kpr: {
    ...
    ctaHref: "#kontak",
    disclaimer:
      "*Perhitungan ini hanya estimasi. Cicilan aktual dapat berbeda tergantung kebijakan bank dan kondisi kredit Anda.",
  },

  footer: {
    brandDescription:
      "Hunian premium dengan desain modern dan kenyamanan maksimal di jantung Kota Pontianak.",
